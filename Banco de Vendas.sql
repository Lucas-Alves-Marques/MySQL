...
insert into tbl_produto( nome_produto, desc_produto, unid_medida, estoque_atual, estoque_max, valor) 
values('Arroz', 'Arroz Agulhinha tipo 1', 'SC', 10 , 20 , 12.50),
('Feijão', 'Feijão Carioquinha com casca', 'SC',25,60,7.50),
('Macarrão', 'Macarrão Adria epaquete','PC', 50, 80, 5.50),
('Oleo', 'Oleo Lisa', 'LT', 15 , 45, 6.50),
('Vinagre', 'Vinagre Castelo', 'GR', 30, 50, 7.89),
('Batata', 'Batata Lavada', 'KG', 100, 200, 4.50),
('Tomate', 'Tomate Vermelho', 'KG', 80, 160, 6.90),
('Cebola', 'Cebola com casca', 'KG', 50, 100, 6.99),
('Leite' , 'Leite leco', 'CX', 25, 90, 2.50),
('Cafe', 'Cafe do Ponto', 'SC', 500 , 200, 11.50);
...
('Cosmólio Ferrreira','41368529687','1966-12-01','6753020','25','apto 255 F'),
('Consegunda Prado','54781269501','1950-10-06','6753020','50','apto 166C'),
('Brogundes Asmõnio','41256398745','1940-05-10','6753400','100',''),
('Iscruência da Silva','12457965823','1974-11-25','6803040','5',''),
('Zizafãnio Zizundo','54123698562','1934-08-14','6803140','25',''),
('Ricuerda Zunda','21698534589','1934-10-14','6803045','123',''),
('Anioando Zinzão','25639856971','1976-12-25','6803070','50','');
...
insert into	tbl_pedido(data_pedido, data_entrega,cod_cliente) value ('2024-04-27','2024-05-11',1);

insert into	tbl_pedido(data_pedido, data_entrega,cod_cliente) value ('2024-05-07','2024-05-13',7),('2024-06-12','2024-06-28',3),('2024-05-07','2024-05-13',8),('2024-03-15','2024-03-17',5);
...
i_cod_pedido	int unsigned not null,  #vem da tbl pedido
i_cod_produto	int unsigned not null, #vem da tbl produto (já foi)
...
insert into tbl_itempedido (  i_cod_produto, qtde, i_valor, i_cod_pedido) values
(1, 10, 12.50, 2);
...
select i_cod_pedido, i_cod_produto, qtde, i_valor from tbl_itempedido;
...
select * from tbl_endereco;
select count(*) as qtd, cidade from tbl_endereco group by cidade;

/*
Querys - 2
*/

select count(*) as qtd, bairro from tbl_endereco group by bairro order by logradouro desc;
...
select * from tbl_cliente where year(data_nasc) > 1960 and year(data_nasc) < 1999;

/*
Querys - 4
*/

select count(*) as qtd, month(data_nasc) mes from tbl_cliente group by 2 order by 1 desc;

/*
Querys - 5
*/

select count(*) as qtd, month(data_pedido) mes from tbl_pedido group by 2 order by 1 desc;

/*
Querys - 6
*/

select min(i_valor ) as menorPreco from tbl_itempedido;

/*
Querys - 7
*/

select sum(qtde) as qtd, i_cod_produto from tbl_itempedido group by 2 order by 1 desc;

/*
Querys - 8
*/

select sum(estoque_atual) as qtd_no_estoque from tbl_produto;

/*
Querys - 9
*/

select avg(estoque_atual) as qtd_no_estoque from tbl_produto;

/*
Querys - 10
*/

select sum(estoque_atual * valor) as valor_no_estoque from tbl_produto;

								#JOINS

select * from tbl_cliente as c, tbl_pedido as p
...
where c.cod_cliente = p.cod_cliente and p.data_pedido > "2014-01-30";
...
drop view vw_pedidos2;

select * from vw_pedidos2;

# Questão C

create view	vw_pedidos3 as
select p.cod_pedido, p.cod_cliente, i.qtde, i.i_cod_produto, pr.desc_produto
from tbl_pedido p, tbl_itempedido i, tbl_produto pr
where  i.i_cod_produto = pr.cod_produto;

drop view vw_pedidos3;

select * from vw_pedidos3;

# Questão D

create view	vw_produto (cod_produto, desc_produto, valor_inicial, valor_ajuste)as
select pr.cod_produto, pr.desc_produto, pr.valor, sum(pr.valor * 0.112 + pr.valor)
from tbl_produto pr
