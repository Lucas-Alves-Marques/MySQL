...
insert into tbl_endereco (id, cep, logadouro, bairro, cidade, estado) VALUES
...
insert into tbl_produtos (nome_produto, desc_produto, unid_medida, estoque_atual ,estoque_min, estoque_max, valor) VALUES
('Feijão', 'Feijão carioca tipo 1', 'KG', 15, 3, 20, 70),
('Açúcar', 'Açúcar cristal', 'KG', 12, 5, 15, 40),
('Sal', 'Sal refinado', 'KG', 20, 10, 25, 15),
('Óleo', 'Óleo de soja', 'L', 8, 2, 10, 25),
('Macarrão', 'Macarrão tipo espaguete', 'KG', 5, 1, 8, 12),
('Café', 'Café torrado e moído', 'KG', 6, 1, 6, 30),
('Leite', 'Leite integral', 'L', 20, 5, 30, 4),
('Queijo', 'Queijo muçarela fatiado', 'KG', 7, 3, 10, 40),
('Presunto', 'Presunto fatiado', 'KG', 4, 2, 6, 30),
('Ovo', 'Ovos brancos', 'DZ', 3, 1, 4, 18),
('Frango', 'Peito de frango congelado', 'KG', 25, 5, 30, 15),
('Carne', 'Carne bovina moída', 'KG', 18, 5, 25, 35),
('Pão', 'Pão de forma', 'UN', 30, 10, 40, 6),
('Manteiga', 'Manteiga sem sal', 'KG', 5, 1, 7, 25),
('Iogurte', 'Iogurte natural', 'UN', 15, 5, 20, 3),
('Tomate', 'Tomate fresco', 'KG', 10, 2, 15, 4),
('Cenoura', 'Cenoura fresca', 'KG', 8, 3, 12, 3),
('Batata', 'Batata inglesa', 'KG', 12, 4, 15, 2),
('Cebola', 'Cebola roxa', 'KG', 9, 3, 10, 2),
('Maçã', 'Maçã nacional', 'KG', 7, 2, 10, 8);